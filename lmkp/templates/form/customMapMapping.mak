    ...
    <div class="row" style="margin-top: 10px;">
        ...
        <div class="input-field col s12" action="">
            ...
            <div class="col s6" style="margin: 0; padding: 0;">
                ...
                <button type="submit" value="Search" id="search-submit" class="btn tooltipped" style="line-height: 30px; height: 30px;" name="action" data-position="top" data-delay="50" data-tooltip="${_('Start to search for a location by typing in the search field.')}"><i class="material-icons">search</i></button>
            </div>
        </div>
    </div>
