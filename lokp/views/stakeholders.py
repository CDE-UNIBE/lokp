...
from lokp.models import DBSession, Stakeholder, Language, SH_Key, SH_Tag, \
    SH_Tag_Group
...
from lokp.utils.views import get_output_format, get_page_parameters, \
    get_status_parameter, handle_query_string, get_current_profile, \
    get_current_locale, validate_uuid, get_bbox_parameters, shorten_uuid
from lokp.views.download import DownloadView
from lokp.views.form import renderForm, renderReadonlyForm, \
    renderReadonlyCompareForm
from lokp.views.translation import get_translated_db_keys, get_translated_status

stakeholder_protocol = StakeholderProtocol(DBSession)
...
class StakeholderView(BaseView):
    ...
    def create(self):
        ...
        try:
            ...
            raise HTTPBadRequest('You must provide a JSON body.')
    ...
    def review(self):
        ...
        stakeholder = DBSession.query(Stakeholder). \
            filter(
        ...
        if review_decision == 1 and len(stakeholder.tag_groups) > 0:
            ...
            stakeholder_keys = DBSession.query(SH_Key.key). \
                join(SH_Tag). \
