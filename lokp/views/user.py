...
from pyramid.security import authenticated_userid, has_permission, ACLAllowed
...
from lokp.config.customization import get_default_profile, \
    get_customized_template_path, _processProfile
from lokp.models import User, Profile, Group, users_groups, users_profiles
...
class UserView(BaseView):
    ...
    def register(self):
        ...
        class Schema(colander.Schema):
            ...
            firstname = colander.SchemaNode(
                colander.String(), missing=str(u''), title=_('First Name'))
            lastname = colander.SchemaNode(
                colander.String(), missing=str(u''), title=_('Last Name'))
    ...
    def activate(self):
        ...
        # Get the user
        user = DBSession.query(User).filter(and_(
